...
* [conflict:Personal_weapon](class-conflictpersonal_weapon.md)
    ...
    * conflict:Flamethrower


        * [conflict:Grossflammenwerfer](class-conflictgrossflammenwerfer.md) 

        * [conflict:Kleinflammenwerfer](class-conflictkleinflammenwerfer.md) 
...
### URI
http://purl.com/net/conflict#Flamethrower
...
<p>:Flamethrower a owl:Class ;<br />    rdfs:comment &quot;The basic idea of a flamethrower is to spread fire by launching burning fuel.&quot;^^xsd:string ;<br />    rdfs:subClassOf :Personal_weapon .</p>
...
### Instances of conflict:Flamethrower can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="conflict:Flamethrower" href="class-conflictflamethrower.md" class="rdfclass">conflict:Flamethrower</a></span>
            </th>
        </tr>       
