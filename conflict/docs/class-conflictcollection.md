...
* [conflict:Physical](class-conflictphysical.md)
    ...
    * conflict:Collection
        ...
        * [conflict:Naval_Fleet](class-conflictnaval_fleet.md) 
...
### URI
http://purl.com/net/conflict#Collection
...
<p>:Collection a owl:Class ;<br />    rdfs:subClassOf :Physical ;<br />    owl:disjointWith :Single_Thing .</p>
...
### Instances of conflict:Collection can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="conflict:Collection" href="class-conflictcollection.md" class="rdfclass">conflict:Collection</a></span>
            </th>
        </tr>       
