...
* [conflict:Recording](class-conflictrecording.md)
    ...
    * conflict:Report
        ...
        * [conflict:CourseAssignment_Report](class-conflictcourseassignment_report.md) 

        * [conflict:Encounter_Report](class-conflictencounter_report.md) 

        * [conflict:EnterService_Report](class-conflictenterservice_report.md) 

        * [conflict:RankAssignment_Report](class-conflictrankassignment_report.md) 

        * [conflict:ShipAssignment_Report](class-conflictshipassignment_report.md) 
...
### URI
http://purl.com/net/conflict#Report
...
<p>:Report a owl:Class ;<br />    rdfs:subClassOf :Recording .</p>
...
### Instances of conflict:Report can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="conflict:Report" href="class-conflictreport.md" class="rdfclass">conflict:Report</a></span>
            </th>
        </tr>       
