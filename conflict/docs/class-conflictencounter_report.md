...
## Class conflict:Encounter_Report
...
* [conflict:Report](class-conflictreport.md)
    ...
    * conflict:Encounter_Report


        * [conflict:Ship_encounter](class-conflictship_encounter.md) 

        * [conflict:Storm_encounter](class-conflictstorm_encounter.md) 
...
### URI
http://purl.com/net/conflict#Encounter_Report
...
<p>:Encounter_Report a owl:Class ;<br />    rdfs:subClassOf :Report .</p>
...
### Instances of conflict:Encounter_Report can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="conflict:Encounter_Report" href="class-conflictencounter_report.md" class="rdfclass">conflict:Encounter_Report</a></span>
            </th>
        </tr>       
