...
* [conflict:Abstract](class-conflictabstract.md)
    ...
    * conflict:Work
        ...
        * [conflict:Naval_Service_Record](class-conflictnaval_service_record.md) 

        * [conflict:Plan](class-conflictplan.md) 

        * [conflict:ShipLog_Record](class-conflictshiplog_record.md) 
...
### URI
http://purl.com/net/conflict#Work
...
<p>:Work a owl:Class ;<br />    rdfs:comment &quot;FRBR work&quot;^^rdf:XMLLiteral ;<br />    rdfs:subClassOf :Abstract .</p>
...
### Instances of conflict:Work can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="conflict:Work" href="class-conflictwork.md" class="rdfclass">conflict:Work</a></span>
            </th>
        </tr>       
