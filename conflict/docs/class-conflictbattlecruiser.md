...
### URI
http://purl.com/net/conflict#Battlecruiser
...
<p>:Battlecruiser a owl:Class ;<br />    rdfs:comment &quot;A ship with battleship level armament and cruiser level armor; typically faster than a battleship because the reduction in armor allowed mounting of heavier propulsion machinery.&quot;^^rdf:XMLLiteral ;<br />    rdfs:subClassOf :Warship .</p>
...
### Instances of conflict:Battlecruiser can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="conflict:Battlecruiser" href="class-conflictbattlecruiser.md" class="rdfclass">conflict:Battlecruiser</a></span>
            </th>
        </tr>       
