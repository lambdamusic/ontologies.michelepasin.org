...
### URI
http://purl.com/net/conflict#book
...
<p>:book a owl:Class ;<br />    rdfs:subClassOf :Single_Thing .</p>
...
### Instances of conflict:book can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="conflict:book" href="class-conflictbook.md" class="rdfclass">conflict:book</a></span>
            </th>
        </tr>       
