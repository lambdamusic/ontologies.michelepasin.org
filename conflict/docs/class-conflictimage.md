...
* [conflict:Expression](class-conflictexpression.md)
    ...
    * conflict:Image
        ...
        * [conflict:ServiceRecord_Image](class-conflictservicerecord_image.md) 

        * [conflict:ShipLog_Image](class-conflictshiplog_image.md) 
...
### URI
http://purl.com/net/conflict#Image
...
<p>:Image a owl:Class ;<br />    rdfs:subClassOf :Expression .</p>
...
### Instances of conflict:Image can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="conflict:Image" href="class-conflictimage.md" class="rdfclass">conflict:Image</a></span>
            </th>
        </tr>       
