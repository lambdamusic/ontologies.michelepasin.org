...
* [conflict:Single_Thing](class-conflictsingle_thing.md)
    ...
    * conflict:Military_Post


        * [conflict:Machine_Gun_Post](class-conflictmachine_gun_post.md) 
...
### URI
http://purl.com/net/conflict#Military_Post
...
<p>:Military_Post a owl:Class ;<br />    rdfs:subClassOf :Single_Thing .</p>
...
### Instances of conflict:Military_Post can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="conflict:Military_Post" href="class-conflictmilitary_post.md" class="rdfclass">conflict:Military_Post</a></span>
            </th>
        </tr>       
