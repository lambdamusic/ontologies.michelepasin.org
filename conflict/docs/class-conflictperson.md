...
### URI
http://purl.com/net/conflict#Person
...
<p>:Person a owl:Class ;<br />    rdfs:subClassOf :Agent .</p>
...
### Instances of conflict:Person can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="conflict:Person" href="class-conflictperson.md" class="rdfclass">conflict:Person</a></span>
            </th>
        </tr>       
