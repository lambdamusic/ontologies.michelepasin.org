...
## Class conflict:Military_vehicle
...
* [conflict:Single_Thing](class-conflictsingle_thing.md)
    ...
    * conflict:Military_vehicle


        * [conflict:Commer_Ambulance](class-conflictcommer_ambulance.md) 

        * [conflict:Military_Motor_Bus](class-conflictmilitary_motor_bus.md) 
...
### URI
http://purl.com/net/conflict#Military_vehicle
...
<p>:Military_vehicle a owl:Class ;<br />    rdfs:subClassOf :Single_Thing .</p>
...
### Instances of conflict:Military_vehicle can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="conflict:Military_vehicle" href="class-conflictmilitary_vehicle.md" class="rdfclass">conflict:Military_vehicle</a></span>
            </th>
        </tr>       
