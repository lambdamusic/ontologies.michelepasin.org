...
### URI
http://purl.com/net/conflict#Rocket

### Description
&quot;A rocket is a weapon that uses a chemical propellant to accelerate a projectile; for example a warhead. A rocket and its payload are generally referred to together as a missile&quot;
...
<p>:Rocket a owl:Class ;<br />    rdfs:comment &quot;A rocket is a weapon that uses a chemical propellant to accelerate a projectile; for example a warhead. A rocket and its payload are generally referred to together as a missile&quot;^^xsd:string ;<br />    rdfs:subClassOf :Weapon_by_Function .</p>
...
### Instances of conflict:Rocket can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="conflict:Rocket" href="class-conflictrocket.md" class="rdfclass">conflict:Rocket</a></span>
            </th>
        </tr>       
