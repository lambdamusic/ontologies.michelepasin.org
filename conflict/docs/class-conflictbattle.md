...
* [conflict:Event](class-conflictevent.md)
    ...
    * conflict:Battle
        ...
        * [conflict:Land_Battle](class-conflictland_battle.md) 

        * [conflict:Naval_Battle](class-conflictnaval_battle.md) 
...
### URI
http://purl.com/net/conflict#Battle
...
<p>:Battle a owl:Class ;<br />    rdfs:subClassOf :Event .</p>
...
### Instances of conflict:Battle can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="conflict:Battle" href="class-conflictbattle.md" class="rdfclass">conflict:Battle</a></span>
            </th>
        </tr>       
