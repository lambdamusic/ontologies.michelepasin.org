...
## Property feudalism:transaction_Addressee


### Tree

* rdfs:Property
    * feudalism:transaction_Addressee
...
### URI
http://www.purl.com/net/feudalism#transaction_Addressee
...
=&gt;&nbsp;_feudalism:transaction_Addressee_&nbsp;=&gt;&nbsp;[](.md)
...
<p>:transaction_Addressee a owl:ObjectProperty ;<br />    rdfs:label &quot;Addressee&quot;^^xsd:string ;<br />    rdfs:domain :Transaction ;<br />    rdfs:range factoid:Agent ;<br />    rdfs:subPropertyOf factoid:had_participant .</p>
