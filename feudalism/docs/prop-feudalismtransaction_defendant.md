...
## Property feudalism:transaction_Defendant


### Tree

* rdfs:Property
    * feudalism:transaction_Defendant
...
### URI
http://www.purl.com/net/feudalism#transaction_Defendant
...
=&gt;&nbsp;_feudalism:transaction_Defendant_&nbsp;=&gt;&nbsp;[](.md)
...
<p>:transaction_Defendant a owl:ObjectProperty ;<br />    rdfs:label &quot;Defendant&quot;^^xsd:string ;<br />    rdfs:domain :Transaction ;<br />    rdfs:range factoid:Agent ;<br />    rdfs:subPropertyOf factoid:had_participant .</p>
