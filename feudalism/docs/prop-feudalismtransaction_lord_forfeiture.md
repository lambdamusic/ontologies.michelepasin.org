...
## Property feudalism:transaction_Lord_forfeiture


### Tree

* rdfs:Property
    * feudalism:transaction_Lord_forfeiture
...
### URI
http://www.purl.com/net/feudalism#transaction_Lord_forfeiture
...
=&gt;&nbsp;_feudalism:transaction_Lord_forfeiture_&nbsp;=&gt;&nbsp;[](.md)
...
<p>:transaction_Lord_forfeiture a owl:ObjectProperty ;<br />    rdfs:label &quot;Lord (forfeiture)&quot;^^xsd:string ;<br />    rdfs:domain :Transaction ;<br />    rdfs:range factoid:Agent ;<br />    rdfs:subPropertyOf factoid:had_participant .</p>
