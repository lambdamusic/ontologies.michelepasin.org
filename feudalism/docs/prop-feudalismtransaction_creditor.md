...
## Property feudalism:transaction_Creditor


### Tree

* rdfs:Property
    * feudalism:transaction_Creditor
...
### URI
http://www.purl.com/net/feudalism#transaction_Creditor
...
=&gt;&nbsp;_feudalism:transaction_Creditor_&nbsp;=&gt;&nbsp;[](.md)
...
<p>:transaction_Creditor a owl:ObjectProperty ;<br />    rdfs:label &quot;Creditor&quot;^^xsd:string ;<br />    rdfs:domain :Transaction ;<br />    rdfs:range factoid:Agent ;<br />    rdfs:subPropertyOf factoid:had_participant .</p>
