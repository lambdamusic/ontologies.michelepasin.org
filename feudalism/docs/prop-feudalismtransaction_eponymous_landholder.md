...
## Property feudalism:transaction_Eponymous_landholder


### Tree

* rdfs:Property
    * feudalism:transaction_Eponymous_landholder
...
### URI
http://www.purl.com/net/feudalism#transaction_Eponymous_landholder
...
=&gt;&nbsp;_feudalism:transaction_Eponymous_landholder_&nbsp;=&gt;&nbsp;[](.md)
...
<p>:transaction_Eponymous_landholder a owl:ObjectProperty ;<br />    rdfs:label &quot;Eponymous landholder&quot;^^xsd:string ;<br />    rdfs:domain :Transaction ;<br />    rdfs:range factoid:Agent ;<br />    rdfs:subPropertyOf factoid:had_participant .</p>
