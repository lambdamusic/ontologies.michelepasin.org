...
## Property feudalism:transaction_Prisoner_Roslin


### Tree

* rdfs:Property
    * feudalism:transaction_Prisoner_Roslin
...
### URI
http://www.purl.com/net/feudalism#transaction_Prisoner_Roslin
...
=&gt;&nbsp;_feudalism:transaction_Prisoner_Roslin_&nbsp;=&gt;&nbsp;[](.md)
...
<p>:transaction_Prisoner_Roslin a owl:ObjectProperty ;<br />    rdfs:label &quot;Prisoner (Roslin)&quot;^^xsd:string ;<br />    rdfs:domain :Transaction ;<br />    rdfs:range factoid:Agent ;<br />    rdfs:subPropertyOf factoid:had_participant .</p>
