...
## Property feudalism:transaction_in_the_time_of_tempore


### Tree

* rdfs:Property
    * feudalism:transaction_in_the_time_of_tempore
...
### URI
http://www.purl.com/net/feudalism#transaction_in_the_time_of_tempore
...
=&gt;&nbsp;_feudalism:transaction_in_the_time_of_tempore_&nbsp;=&gt;&nbsp;[](.md)
...
<p>:transaction_in_the_time_of_tempore a owl:ObjectProperty ;<br />    rdfs:label &quot;in the time of (tempore)&quot;^^xsd:string ;<br />    rdfs:domain :Transaction ;<br />    rdfs:range factoid:Agent ;<br />    rdfs:subPropertyOf factoid:had_participant .</p>
