...
## Property feudalism:transaction_Recipient_submission_fealty_homage


### Tree

* rdfs:Property
    * feudalism:transaction_Recipient_submission_fealty_homage
...
### URI
http://www.purl.com/net/feudalism#transaction_Recipient_submission_fealty_homage
...
=&gt;&nbsp;_feudalism:transaction_Recipient_submission_fealty_homage_&nbsp;=&gt;&nbsp;[](.md)
...
<p>:transaction_Recipient_submission_fealty_homage a owl:ObjectProperty ;<br />    rdfs:label &quot;Recipient (submission, fealty, homage)&quot;^^xsd:string ;<br />    rdfs:domain :Transaction ;<br />    rdfs:range factoid:Agent ;<br />    rdfs:subPropertyOf factoid:had_participant .</p>
