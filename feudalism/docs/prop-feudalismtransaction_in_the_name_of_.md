...
## Property feudalism:transaction_In_the_name_of_


### Tree

* rdfs:Property
    * feudalism:transaction_In_the_name_of_
...
### URI
http://www.purl.com/net/feudalism#transaction_In_the_name_of_
...
=&gt;&nbsp;_feudalism:transaction_In_the_name_of__&nbsp;=&gt;&nbsp;[](.md)
...
<p>:transaction_In_the_name_of_ a owl:ObjectProperty ;<br />    rdfs:label &quot;In the name of &quot;^^xsd:string ;<br />    rdfs:domain :Transaction ;<br />    rdfs:range factoid:Agent ;<br />    rdfs:subPropertyOf factoid:had_participant .</p>
