...
## Property feudalism:transaction_Pro_salute_anime


### Tree

* rdfs:Property
    * feudalism:transaction_Pro_salute_anime
...
### URI
http://www.purl.com/net/feudalism#transaction_Pro_salute_anime
...
=&gt;&nbsp;_feudalism:transaction_Pro_salute_anime_&nbsp;=&gt;&nbsp;[](.md)
...
<p>:transaction_Pro_salute_anime a owl:ObjectProperty ;<br />    rdfs:label &quot;Pro salute anime&quot;^^xsd:string ;<br />    rdfs:domain :Transaction ;<br />    rdfs:range factoid:Agent ;<br />    rdfs:subPropertyOf factoid:had_participant .</p>
