...
## Class feudalism:Warfare_event


### Tree

* OWL:Thing
    * feudalism:Warfare_event


        * [feudalism:Crusade](class-feudalismcrusade.md) 
...
### URI
http://www.purl.com/net/feudalism#Warfare_event
...
<p>:Warfare_event a owl:Class ;<br />    rdfs:subClassOf factoid:Event .</p>
...
### Instances of feudalism:Warfare_event can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="feudalism:Warfare_event" href="class-feudalismwarfare_event.md" class="rdfclass">feudalism:Warfare_event</a></span>
            </th>
        </tr>       
