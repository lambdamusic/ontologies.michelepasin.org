...
## Class feudalism:Message-sending
...
### URI
http://www.purl.com/net/feudalism#Message-sending
...
<p>:Message-sending a owl:Class ;<br />    rdfs:subClassOf :Political_acts .</p>
...
### Instances of feudalism:Message-sending can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="feudalism:Message-sending" href="class-feudalismmessage-sending.md" class="rdfclass">feudalism:Message-sending</a></span>
            </th>
        </tr>       
