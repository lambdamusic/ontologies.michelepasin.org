...
## Property feudalism:transaction_title-holder


### Tree

* rdfs:Property
    * feudalism:transaction_title-holder
...
### URI
http://www.purl.com/net/feudalism#transaction_title-holder
...
=&gt;&nbsp;_feudalism:transaction_title-holder_&nbsp;=&gt;&nbsp;[](.md)
...
<p>:transaction_title-holder a owl:ObjectProperty ;<br />    rdfs:label &quot;title-holder&quot;^^xsd:string ;<br />    rdfs:domain :Transaction ;<br />    rdfs:range factoid:Agent ;<br />    rdfs:subPropertyOf factoid:had_participant .</p>
