...
## Property feudalism:transaction_Sicut_Clause


### Tree

* rdfs:Property
    * feudalism:transaction_Sicut_Clause
...
### URI
http://www.purl.com/net/feudalism#transaction_Sicut_Clause
...
=&gt;&nbsp;_feudalism:transaction_Sicut_Clause_&nbsp;=&gt;&nbsp;[](.md)
...
<p>:transaction_Sicut_Clause a owl:ObjectProperty ;<br />    rdfs:label &quot;Sicut Clause&quot;^^xsd:string ;<br />    rdfs:domain :Transaction ;<br />    rdfs:range factoid:Agent ;<br />    rdfs:subPropertyOf factoid:had_participant .</p>
