...
## Property feudalism:transaction_named_person_transaction


### Tree

* rdfs:Property
    * feudalism:transaction_named_person_transaction
...
### URI
http://www.purl.com/net/feudalism#transaction_named_person_transaction
...
=&gt;&nbsp;_feudalism:transaction_named_person_transaction_&nbsp;=&gt;&nbsp;[](.md)
...
<p>:transaction_named_person_transaction a owl:ObjectProperty ;<br />    rdfs:label &quot;named person (transaction)&quot;^^xsd:string ;<br />    rdfs:domain :Transaction ;<br />    rdfs:range factoid:Agent ;<br />    rdfs:subPropertyOf factoid:had_participant .</p>
