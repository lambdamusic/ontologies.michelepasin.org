...
## Property feudalism:transaction_Surety_mainpernor


### Tree

* rdfs:Property
    * feudalism:transaction_Surety_mainpernor
...
### URI
http://www.purl.com/net/feudalism#transaction_Surety_mainpernor
...
=&gt;&nbsp;_feudalism:transaction_Surety_mainpernor_&nbsp;=&gt;&nbsp;[](.md)
...
<p>:transaction_Surety_mainpernor a owl:ObjectProperty ;<br />    rdfs:label &quot;Surety/mainpernor&quot;^^xsd:string ;<br />    rdfs:domain :Transaction ;<br />    rdfs:range factoid:Agent ;<br />    rdfs:subPropertyOf factoid:had_participant .</p>
