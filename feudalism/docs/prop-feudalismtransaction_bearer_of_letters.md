...
## Property feudalism:transaction_Bearer_of_letters


### Tree

* rdfs:Property
    * feudalism:transaction_Bearer_of_letters
...
### URI
http://www.purl.com/net/feudalism#transaction_Bearer_of_letters
...
=&gt;&nbsp;_feudalism:transaction_Bearer_of_letters_&nbsp;=&gt;&nbsp;[](.md)
...
<p>:transaction_Bearer_of_letters a owl:ObjectProperty ;<br />    rdfs:label &quot;Bearer of letters&quot;^^xsd:string ;<br />    rdfs:domain :Transaction ;<br />    rdfs:range factoid:Agent ;<br />    rdfs:subPropertyOf factoid:had_participant .</p>
