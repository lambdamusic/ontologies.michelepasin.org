...
## Class feudalism:Rights_and_Privileges
...
* [feudalism:Type](class-feudalismtype.md)
    ...
    * feudalism:Rights_and_Privileges


        * [feudalism:Office](class-feudalismoffice.md) 

        * [feudalism:Privilege](class-feudalismprivilege.md) 
...
### URI
http://www.purl.com/net/feudalism#Rights_and_Privileges
...
<p>:Rights_and_Privileges a owl:Class ;<br />    rdfs:label &quot;Privilege&quot;^^xsd:string ;<br />    rdfs:subClassOf :Type .</p>
...
### Instances of feudalism:Rights_and_Privileges can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="feudalism:Rights_and_Privileges" href="class-feudalismrights_and_privileges.md" class="rdfclass">feudalism:Rights_and_Privileges</a></span>
            </th>
        </tr>       
