...
## Property feudalism:transaction_Signatory


### Tree

* rdfs:Property
    * feudalism:transaction_Signatory
...
### URI
http://www.purl.com/net/feudalism#transaction_Signatory
...
=&gt;&nbsp;_feudalism:transaction_Signatory_&nbsp;=&gt;&nbsp;[](.md)
...
<p>:transaction_Signatory a owl:ObjectProperty ;<br />    rdfs:label &quot;Signatory&quot;^^xsd:string ;<br />    rdfs:domain :Transaction ;<br />    rdfs:range factoid:Agent ;<br />    rdfs:subPropertyOf factoid:had_participant .</p>
