...
## Property feudalism:transaction_Enactor


### Tree

* rdfs:Property
    * feudalism:transaction_Enactor
...
### URI
http://www.purl.com/net/feudalism#transaction_Enactor
...
=&gt;&nbsp;_feudalism:transaction_Enactor_&nbsp;=&gt;&nbsp;[](.md)
...
<p>:transaction_Enactor a owl:ObjectProperty ;<br />    rdfs:label &quot;Enactor&quot;^^xsd:string ;<br />    rdfs:domain :Transaction ;<br />    rdfs:range factoid:Agent ;<br />    rdfs:subPropertyOf factoid:had_participant .</p>
