...
## Property feudalism:transaction_Issuer_of_receipt


### Tree

* rdfs:Property
    * feudalism:transaction_Issuer_of_receipt
...
### URI
http://www.purl.com/net/feudalism#transaction_Issuer_of_receipt
...
=&gt;&nbsp;_feudalism:transaction_Issuer_of_receipt_&nbsp;=&gt;&nbsp;[](.md)
...
<p>:transaction_Issuer_of_receipt a owl:ObjectProperty ;<br />    rdfs:label &quot;Issuer of receipt&quot;^^xsd:string ;<br />    rdfs:domain :Transaction ;<br />    rdfs:range factoid:Agent ;<br />    rdfs:subPropertyOf factoid:had_participant .</p>
