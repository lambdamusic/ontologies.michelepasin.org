...
## Property feudalism:transaction_Lord_possession


### Tree

* rdfs:Property
    * feudalism:transaction_Lord_possession
...
### URI
http://www.purl.com/net/feudalism#transaction_Lord_possession
...
=&gt;&nbsp;_feudalism:transaction_Lord_possession_&nbsp;=&gt;&nbsp;[](.md)
...
<p>:transaction_Lord_possession a owl:ObjectProperty ;<br />    rdfs:label &quot;Lord (possession)&quot;^^xsd:string ;<br />    rdfs:domain :Transaction ;<br />    rdfs:range factoid:Agent ;<br />    rdfs:subPropertyOf factoid:had_participant .</p>
