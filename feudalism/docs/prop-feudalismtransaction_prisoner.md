...
## Property feudalism:transaction_Prisoner


### Tree

* rdfs:Property
    * feudalism:transaction_Prisoner
...
### URI
http://www.purl.com/net/feudalism#transaction_Prisoner
...
=&gt;&nbsp;_feudalism:transaction_Prisoner_&nbsp;=&gt;&nbsp;[](.md)
...
<p>:transaction_Prisoner a owl:ObjectProperty ;<br />    rdfs:label &quot;Prisoner&quot;^^xsd:string ;<br />    rdfs:domain :Transaction ;<br />    rdfs:range factoid:Agent ;<br />    rdfs:subPropertyOf factoid:had_participant .</p>
