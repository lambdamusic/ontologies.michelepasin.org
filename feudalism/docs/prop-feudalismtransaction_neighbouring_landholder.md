...
## Property feudalism:transaction_Neighbouring_landholder


### Tree

* rdfs:Property
    * feudalism:transaction_Neighbouring_landholder
...
### URI
http://www.purl.com/net/feudalism#transaction_Neighbouring_landholder
...
=&gt;&nbsp;_feudalism:transaction_Neighbouring_landholder_&nbsp;=&gt;&nbsp;[](.md)
...
<p>:transaction_Neighbouring_landholder a owl:ObjectProperty ;<br />    rdfs:label &quot;Neighbouring landholder&quot;^^xsd:string ;<br />    rdfs:domain :Transaction ;<br />    rdfs:range factoid:Agent ;<br />    rdfs:subPropertyOf factoid:had_participant .</p>
