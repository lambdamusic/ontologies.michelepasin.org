...
## Property feudalism:transaction_Forfeiter


### Tree

* rdfs:Property
    * feudalism:transaction_Forfeiter
...
### URI
http://www.purl.com/net/feudalism#transaction_Forfeiter
...
=&gt;&nbsp;_feudalism:transaction_Forfeiter_&nbsp;=&gt;&nbsp;[](.md)
...
<p>:transaction_Forfeiter a owl:ObjectProperty ;<br />    rdfs:label &quot;Forfeiter&quot;^^xsd:string ;<br />    rdfs:domain :Transaction ;<br />    rdfs:range factoid:Agent ;<br />    rdfs:subPropertyOf factoid:had_participant .</p>
