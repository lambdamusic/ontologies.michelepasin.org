...
### URI
http://www.purl.com/net/feudalism#Introduction
...
<p>:Introduction a owl:Class ;<br />    rdfs:subClassOf :Social_and_economic_acts_and_relations .</p>
...
### Instances of feudalism:Introduction can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="feudalism:Introduction" href="class-feudalismintroduction.md" class="rdfclass">feudalism:Introduction</a></span>
            </th>
        </tr>       
