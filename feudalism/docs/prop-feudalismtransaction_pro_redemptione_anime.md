...
## Property feudalism:transaction_pro_redemptione_anime


### Tree

* rdfs:Property
    * feudalism:transaction_pro_redemptione_anime
...
### URI
http://www.purl.com/net/feudalism#transaction_pro_redemptione_anime
...
=&gt;&nbsp;_feudalism:transaction_pro_redemptione_anime_&nbsp;=&gt;&nbsp;[](.md)
...
<p>:transaction_pro_redemptione_anime a owl:ObjectProperty ;<br />    rdfs:label &quot;pro redemptione anime&quot;^^xsd:string ;<br />    rdfs:domain :Transaction ;<br />    rdfs:range factoid:Agent ;<br />    rdfs:subPropertyOf factoid:had_participant .</p>
