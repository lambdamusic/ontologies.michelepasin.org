...
## Property feudalism:transaction_Essoiner_court


### Tree

* rdfs:Property
    * feudalism:transaction_Essoiner_court
...
### URI
http://www.purl.com/net/feudalism#transaction_Essoiner_court
...
=&gt;&nbsp;_feudalism:transaction_Essoiner_court_&nbsp;=&gt;&nbsp;[](.md)
...
<p>:transaction_Essoiner_court a owl:ObjectProperty ;<br />    rdfs:label &quot;Essoiner (court)&quot;^^xsd:string ;<br />    rdfs:domain :Transaction ;<br />    rdfs:range factoid:Agent ;<br />    rdfs:subPropertyOf factoid:had_participant .</p>
