...
## Property feudalism:transaction_Debtor


### Tree

* rdfs:Property
    * feudalism:transaction_Debtor
...
### URI
http://www.purl.com/net/feudalism#transaction_Debtor
...
=&gt;&nbsp;_feudalism:transaction_Debtor_&nbsp;=&gt;&nbsp;[](.md)
...
<p>:transaction_Debtor a owl:ObjectProperty ;<br />    rdfs:label &quot;Debtor&quot;^^xsd:string ;<br />    rdfs:domain :Transaction ;<br />    rdfs:range factoid:Agent ;<br />    rdfs:subPropertyOf factoid:had_participant .</p>
