...
## Property feudalism:transaction_Current_landholder


### Tree

* rdfs:Property
    * feudalism:transaction_Current_landholder
...
### URI
http://www.purl.com/net/feudalism#transaction_Current_landholder
...
=&gt;&nbsp;_feudalism:transaction_Current_landholder_&nbsp;=&gt;&nbsp;[](.md)
...
<p>:transaction_Current_landholder a owl:ObjectProperty ;<br />    rdfs:label &quot;Current landholder&quot;^^xsd:string ;<br />    rdfs:domain :Transaction ;<br />    rdfs:range factoid:Agent ;<br />    rdfs:subPropertyOf factoid:had_participant .</p>
