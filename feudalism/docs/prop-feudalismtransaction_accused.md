...
## Property feudalism:transaction_Accused


### Tree

* rdfs:Property
    * feudalism:transaction_Accused
...
### URI
http://www.purl.com/net/feudalism#transaction_Accused
...
=&gt;&nbsp;_feudalism:transaction_Accused_&nbsp;=&gt;&nbsp;[](.md)
...
<p>:transaction_Accused a owl:ObjectProperty ;<br />    rdfs:label &quot;Accused&quot;^^xsd:string ;<br />    rdfs:domain :Transaction ;<br />    rdfs:range factoid:Agent ;<br />    rdfs:subPropertyOf factoid:had_participant .</p>
