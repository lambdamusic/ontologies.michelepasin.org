...
## Class feudalism:Building


### Tree


* [feudalism:Physical](class-feudalismphysical.md)

    * feudalism:Building


        * [feudalism:Castle](class-feudalismcastle.md) 
...
### URI
http://www.purl.com/net/feudalism#Building
...
<p>:Building a owl:Class ;<br />    rdfs:subClassOf :Physical .</p>
...
### Instances of feudalism:Building can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="feudalism:Building" href="class-feudalismbuilding.md" class="rdfclass">feudalism:Building</a></span>
            </th>
        </tr>       
