...
## Property feudalism:transaction_Prisoner_Dunbar


### Tree

* rdfs:Property
    * feudalism:transaction_Prisoner_Dunbar
...
### URI
http://www.purl.com/net/feudalism#transaction_Prisoner_Dunbar
...
=&gt;&nbsp;_feudalism:transaction_Prisoner_Dunbar_&nbsp;=&gt;&nbsp;[](.md)
...
<p>:transaction_Prisoner_Dunbar a owl:ObjectProperty ;<br />    rdfs:label &quot;Prisoner (Dunbar)&quot;^^xsd:string ;<br />    rdfs:domain :Transaction ;<br />    rdfs:range factoid:Agent ;<br />    rdfs:subPropertyOf factoid:had_participant .</p>
