...
## Property feudalism:transaction_Party_3


### Tree

* rdfs:Property
    * feudalism:transaction_Party_3
...
### URI
http://www.purl.com/net/feudalism#transaction_Party_3
...
=&gt;&nbsp;_feudalism:transaction_Party_3_&nbsp;=&gt;&nbsp;[](.md)
...
<p>:transaction_Party_3 a owl:ObjectProperty ;<br />    rdfs:label &quot;Party 3&quot;^^xsd:string ;<br />    rdfs:domain :Transaction ;<br />    rdfs:range factoid:Agent ;<br />    rdfs:subPropertyOf factoid:had_participant .</p>
