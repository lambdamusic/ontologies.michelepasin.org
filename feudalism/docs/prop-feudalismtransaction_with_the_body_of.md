...
## Property feudalism:transaction_With_the_body_of


### Tree

* rdfs:Property
    * feudalism:transaction_With_the_body_of
...
### URI
http://www.purl.com/net/feudalism#transaction_With_the_body_of
...
=&gt;&nbsp;_feudalism:transaction_With_the_body_of_&nbsp;=&gt;&nbsp;[](.md)
...
<p>:transaction_With_the_body_of a owl:ObjectProperty ;<br />    rdfs:label &quot;With the body of&quot;^^xsd:string ;<br />    rdfs:domain :Transaction ;<br />    rdfs:range factoid:Agent ;<br />    rdfs:subPropertyOf factoid:had_participant .</p>
