...
## Property feudalism:transaction_pro_redemptione


### Tree

* rdfs:Property
    * feudalism:transaction_pro_redemptione
...
### URI
http://www.purl.com/net/feudalism#transaction_pro_redemptione
...
=&gt;&nbsp;_feudalism:transaction_pro_redemptione_&nbsp;=&gt;&nbsp;[](.md)
...
<p>:transaction_pro_redemptione a owl:ObjectProperty ;<br />    rdfs:label &quot;pro redemptione&quot;^^xsd:string ;<br />    rdfs:domain :Transaction ;<br />    rdfs:range factoid:Agent ;<br />    rdfs:subPropertyOf factoid:had_participant .</p>
