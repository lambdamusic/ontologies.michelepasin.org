...
## Property feudalism:transaction_in_the_presence_of


### Tree

* rdfs:Property
    * feudalism:transaction_in_the_presence_of
...
### URI
http://www.purl.com/net/feudalism#transaction_in_the_presence_of
...
=&gt;&nbsp;_feudalism:transaction_in_the_presence_of_&nbsp;=&gt;&nbsp;[](.md)
...
<p>:transaction_in_the_presence_of a owl:ObjectProperty ;<br />    rdfs:label &quot;in the presence of&quot;^^xsd:string ;<br />    rdfs:domain :Transaction ;<br />    rdfs:range factoid:Agent ;<br />    rdfs:subPropertyOf factoid:had_participant .</p>
