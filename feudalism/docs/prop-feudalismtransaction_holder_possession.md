...
## Property feudalism:transaction_Holder_possession


### Tree

* rdfs:Property
    * feudalism:transaction_Holder_possession
...
### URI
http://www.purl.com/net/feudalism#transaction_Holder_possession
...
=&gt;&nbsp;_feudalism:transaction_Holder_possession_&nbsp;=&gt;&nbsp;[](.md)
...
<p>:transaction_Holder_possession a owl:ObjectProperty ;<br />    rdfs:label &quot;Holder (possession)&quot;^^xsd:string ;<br />    rdfs:domain :Transaction ;<br />    rdfs:range factoid:Agent ;<br />    rdfs:subPropertyOf factoid:had_participant .</p>
