...
## Property feudalism:transaction_Perambulator


### Tree

* rdfs:Property
    * feudalism:transaction_Perambulator
...
### URI
http://www.purl.com/net/feudalism#transaction_Perambulator
...
=&gt;&nbsp;_feudalism:transaction_Perambulator_&nbsp;=&gt;&nbsp;[](.md)
...
<p>:transaction_Perambulator a owl:ObjectProperty ;<br />    rdfs:label &quot;Perambulator&quot;^^xsd:string ;<br />    rdfs:domain :Transaction ;<br />    rdfs:range factoid:Agent ;<br />    rdfs:subPropertyOf factoid:had_participant .</p>
