...
## Property feudalism:transaction_Previous_landholder


### Tree

* rdfs:Property
    * feudalism:transaction_Previous_landholder
...
### URI
http://www.purl.com/net/feudalism#transaction_Previous_landholder
...
=&gt;&nbsp;_feudalism:transaction_Previous_landholder_&nbsp;=&gt;&nbsp;[](.md)
...
<p>:transaction_Previous_landholder a owl:ObjectProperty ;<br />    rdfs:label &quot;Previous landholder&quot;^^xsd:string ;<br />    rdfs:domain :Transaction ;<br />    rdfs:range factoid:Agent ;<br />    rdfs:subPropertyOf factoid:had_participant .</p>
