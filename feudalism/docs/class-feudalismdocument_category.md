...
## Class feudalism:Document_category
...
* [feudalism:Type](class-feudalismtype.md)
    ...
    * feudalism:Document_category


        * [feudalism:Grantor_category](class-feudalismgrantor_category.md) 
...
### URI
http://www.purl.com/net/feudalism#Document_category
...
<p>:Document_category a owl:Class ;<br />    rdfs:subClassOf :Type .</p>
...
### Instances of feudalism:Document_category can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="feudalism:Document_category" href="class-feudalismdocument_category.md" class="rdfclass">feudalism:Document_category</a></span>
            </th>
        </tr>       
