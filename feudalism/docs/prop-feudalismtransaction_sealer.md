...
## Property feudalism:transaction_Sealer


### Tree

* rdfs:Property
    * feudalism:transaction_Sealer
...
### URI
http://www.purl.com/net/feudalism#transaction_Sealer
...
=&gt;&nbsp;_feudalism:transaction_Sealer_&nbsp;=&gt;&nbsp;[](.md)
...
<p>:transaction_Sealer a owl:ObjectProperty ;<br />    rdfs:label &quot;Sealer&quot;^^xsd:string ;<br />    rdfs:domain :Transaction ;<br />    rdfs:range factoid:Agent ;<br />    rdfs:subPropertyOf factoid:had_participant .</p>
