...
## Property feudalism:transaction_Addressor


### Tree

* rdfs:Property
    * feudalism:transaction_Addressor
...
### URI
http://www.purl.com/net/feudalism#transaction_Addressor
...
=&gt;&nbsp;_feudalism:transaction_Addressor_&nbsp;=&gt;&nbsp;[](.md)
...
<p>:transaction_Addressor a owl:ObjectProperty ;<br />    rdfs:label &quot;Addressor&quot;^^xsd:string ;<br />    rdfs:domain :Transaction ;<br />    rdfs:range factoid:Agent ;<br />    rdfs:subPropertyOf factoid:had_participant .</p>
