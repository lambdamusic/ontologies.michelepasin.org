...
### URI
http://www.purl.com/net/feudalism#Service
...
<p>:Service a owl:Class ;<br />    rdfs:subClassOf :Social_and_economic_acts_and_relations .</p>
...
### Instances of feudalism:Service can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="feudalism:Service" href="class-feudalismservice.md" class="rdfclass">feudalism:Service</a></span>
            </th>
        </tr>       
