...
## Property feudalism:transaction_undefined_role


### Tree

* rdfs:Property
    * feudalism:transaction_undefined_role
...
### URI
http://www.purl.com/net/feudalism#transaction_undefined_role
...
=&gt;&nbsp;_feudalism:transaction_undefined_role_&nbsp;=&gt;&nbsp;[](.md)
...
<p>:transaction_undefined_role a owl:ObjectProperty ;<br />    rdfs:label &quot;undefined (transaction)&quot;^^xsd:string ;<br />    rdfs:domain :Transaction ;<br />    rdfs:range factoid:Agent ;<br />    rdfs:subPropertyOf factoid:had_participant .</p>
