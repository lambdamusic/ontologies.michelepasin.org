...
## Class feudalism:Agreement_transaction
...
* [feudalism:Transaction](class-feudalismtransaction.md)
    ...
    * feudalism:Agreement_transaction


        * [feudalism:Concession_agreement_transaction](class-feudalismconcession_agreement_transaction.md) 

        * [feudalism:Confirmation_agreement_transaction](class-feudalismconfirmation_agreement_transaction.md) 

        * [feudalism:Gift_agreement_transaction](class-feudalismgift_agreement_transaction.md) 

        * [feudalism:Grant_agreement_transaction](class-feudalismgrant_agreement_transaction.md) 

        * [feudalism:Lease_agreement_transaction](class-feudalismlease_agreement_transaction.md) 

        * [feudalism:Obligation_agreement_transaction](class-feudalismobligation_agreement_transaction.md) 

        * [feudalism:Quitclaim_agreement_transaction](class-feudalismquitclaim_agreement_transaction.md) 

        * [feudalism:Relaxation_agreement_transaction](class-feudalismrelaxation_agreement_transaction.md) 

        * [feudalism:Renewal_agreement_transaction](class-feudalismrenewal_agreement_transaction.md) 

        * [feudalism:Renunciation_agreement_transaction](class-feudalismrenunciation_agreement_transaction.md) 

        * [feudalism:Resignation_agreement_transaction](class-feudalismresignation_agreement_transaction.md) 

        * [feudalism:Sale_agreement_transaction](class-feudalismsale_agreement_transaction.md) 
...
### URI
http://www.purl.com/net/feudalism#Agreement_transaction
...
<p>:Agreement_transaction a owl:Class ;<br />    rdfs:comment &quot;Subtype of Transaction&quot;^^xsd:string ;<br />    rdfs:subClassOf :Transaction .</p>
...
### Instances of feudalism:Agreement_transaction can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="feudalism:Agreement_transaction" href="class-feudalismagreement_transaction.md" class="rdfclass">feudalism:Agreement_transaction</a></span>
            </th>
        </tr>       
