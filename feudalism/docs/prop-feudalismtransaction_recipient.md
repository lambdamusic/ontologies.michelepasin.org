...
## Property feudalism:transaction_Recipient


### Tree

* rdfs:Property
    * feudalism:transaction_Recipient
...
### URI
http://www.purl.com/net/feudalism#transaction_Recipient
...
=&gt;&nbsp;_feudalism:transaction_Recipient_&nbsp;=&gt;&nbsp;[](.md)
...
<p>:transaction_Recipient a owl:ObjectProperty ;<br />    rdfs:label &quot;Recipient&quot;^^xsd:string ;<br />    rdfs:domain :Transaction ;<br />    rdfs:range factoid:Agent ;<br />    rdfs:subPropertyOf factoid:had_participant .</p>
