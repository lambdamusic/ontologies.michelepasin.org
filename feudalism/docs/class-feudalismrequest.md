...
### URI
http://www.purl.com/net/feudalism#Request
...
<p>:Request a owl:Class ;<br />    rdfs:subClassOf :Life_events .</p>
...
### Instances of feudalism:Request can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="feudalism:Request" href="class-feudalismrequest.md" class="rdfclass">feudalism:Request</a></span>
            </th>
        </tr>       
