...
## Property feudalism:transaction_Party_1


### Tree

* rdfs:Property
    * feudalism:transaction_Party_1
...
### URI
http://www.purl.com/net/feudalism#transaction_Party_1
...
=&gt;&nbsp;_feudalism:transaction_Party_1_&nbsp;=&gt;&nbsp;[](.md)
...
<p>:transaction_Party_1 a owl:ObjectProperty ;<br />    rdfs:label &quot;Party 1&quot;^^xsd:string ;<br />    rdfs:domain :Transaction ;<br />    rdfs:range factoid:Agent ;<br />    rdfs:subPropertyOf factoid:had_participant .</p>
