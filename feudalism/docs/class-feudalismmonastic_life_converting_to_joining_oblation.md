...
## Class feudalism:Monastic_life_converting_to_joining_oblation
...
* [feudalism:Acts_of_ecclesiastical_authority](class-feudalismacts_of_ecclesiastical_authority.md)
    ...
    * feudalism:Monastic_life_converting_to_joining_oblation
...
### URI
http://www.purl.com/net/feudalism#Monastic_life_converting_to_joining_oblation
...
<p>:Monastic_life_converting_to_joining_oblation a owl:Class ;<br />    rdfs:subClassOf :Acts_of_ecclesiastical_authority .</p>
...
### Instances of feudalism:Monastic_life_converting_to_joining_oblation can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="feudalism:Monastic_life_converting_to_joining_oblation" href="class-feudalismmonastic_life_converting_to_joining_oblation.md" class="rdfclass">feudalism:Monastic_life_converting_to_joining_oblation</a></span>
            </th>
        </tr>       
