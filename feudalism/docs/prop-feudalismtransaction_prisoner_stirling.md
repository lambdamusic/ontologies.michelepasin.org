...
## Property feudalism:transaction_Prisoner_Stirling


### Tree

* rdfs:Property
    * feudalism:transaction_Prisoner_Stirling
...
### URI
http://www.purl.com/net/feudalism#transaction_Prisoner_Stirling
...
=&gt;&nbsp;_feudalism:transaction_Prisoner_Stirling_&nbsp;=&gt;&nbsp;[](.md)
...
<p>:transaction_Prisoner_Stirling a owl:ObjectProperty ;<br />    rdfs:label &quot;Prisoner (Stirling)&quot;^^xsd:string ;<br />    rdfs:domain :Transaction ;<br />    rdfs:range factoid:Agent ;<br />    rdfs:subPropertyOf factoid:had_participant .</p>
