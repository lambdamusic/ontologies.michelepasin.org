...
## Property feudalism:transaction_Pledge


### Tree

* rdfs:Property
    * feudalism:transaction_Pledge
...
### URI
http://www.purl.com/net/feudalism#transaction_Pledge
...
=&gt;&nbsp;_feudalism:transaction_Pledge_&nbsp;=&gt;&nbsp;[](.md)
...
<p>:transaction_Pledge a owl:ObjectProperty ;<br />    rdfs:label &quot;Pledge&quot;^^xsd:string ;<br />    rdfs:domain :Transaction ;<br />    rdfs:range factoid:Agent ;<br />    rdfs:subPropertyOf factoid:had_participant .</p>
