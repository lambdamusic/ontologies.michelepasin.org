...
## Property feudalism:transaction_Previous_holder_benefice


### Tree

* rdfs:Property
    * feudalism:transaction_Previous_holder_benefice
...
### URI
http://www.purl.com/net/feudalism#transaction_Previous_holder_benefice
...
=&gt;&nbsp;_feudalism:transaction_Previous_holder_benefice_&nbsp;=&gt;&nbsp;[](.md)
...
<p>:transaction_Previous_holder_benefice a owl:ObjectProperty ;<br />    rdfs:label &quot;Previous holder (benefice)&quot;^^xsd:string ;<br />    rdfs:domain :Transaction ;<br />    rdfs:range factoid:Agent ;<br />    rdfs:subPropertyOf factoid:had_participant .</p>
