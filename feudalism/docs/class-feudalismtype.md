...
* [feudalism:Abstract](class-feudalismabstract.md)
    ...
    * feudalism:Type
        ...
        * [feudalism:Document_category](class-feudalismdocument_category.md) 

        * [feudalism:Gender](class-feudalismgender.md) 

        * [feudalism:Language](class-feudalismlanguage.md) 

        * [feudalism:Person_role](class-feudalismperson_role.md) 

        * [feudalism:Rights_and_Privileges](class-feudalismrights_and_privileges.md) 
...
### URI
http://www.purl.com/net/feudalism#Type
...
<p>:Type a owl:Class ;<br />    rdfs:subClassOf :Abstract .</p>
...
### Instances of feudalism:Type can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="feudalism:Type" href="class-feudalismtype.md" class="rdfclass">feudalism:Type</a></span>
            </th>
        </tr>       
