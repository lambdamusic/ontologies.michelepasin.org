...
## Property feudalism:transaction_object_relationship


### Tree

* rdfs:Property
    * feudalism:transaction_object_relationship
...
### URI
http://www.purl.com/net/feudalism#transaction_object_relationship
...
=&gt;&nbsp;_feudalism:transaction_object_relationship_&nbsp;=&gt;&nbsp;[](.md)
...
<p>:transaction_object_relationship a owl:ObjectProperty ;<br />    rdfs:label &quot;object (relationship)&quot;^^xsd:string ;<br />    rdfs:domain :Transaction ;<br />    rdfs:range factoid:Agent ;<br />    rdfs:subPropertyOf factoid:had_participant .</p>
