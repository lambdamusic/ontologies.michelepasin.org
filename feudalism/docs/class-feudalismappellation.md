...
* [feudalism:Abstract](class-feudalismabstract.md)
    ...
    * feudalism:Appellation


        * [feudalism:Date_appellation](class-feudalismdate_appellation.md) 
...
### URI
http://www.purl.com/net/feudalism#Appellation
...
<p>:Appellation a owl:Class ;<br />    rdfs:subClassOf :Abstract .</p>
...
### Instances of feudalism:Appellation can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="feudalism:Appellation" href="class-feudalismappellation.md" class="rdfclass">feudalism:Appellation</a></span>
            </th>
        </tr>       
