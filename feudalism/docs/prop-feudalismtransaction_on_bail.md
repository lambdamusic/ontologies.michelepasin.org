...
## Property feudalism:transaction_On_bail


### Tree

* rdfs:Property
    * feudalism:transaction_On_bail
...
### URI
http://www.purl.com/net/feudalism#transaction_On_bail
...
=&gt;&nbsp;_feudalism:transaction_On_bail_&nbsp;=&gt;&nbsp;[](.md)
...
<p>:transaction_On_bail a owl:ObjectProperty ;<br />    rdfs:label &quot;On bail&quot;^^xsd:string ;<br />    rdfs:domain :Transaction ;<br />    rdfs:range factoid:Agent ;<br />    rdfs:subPropertyOf factoid:had_participant .</p>
