...
## Property feudalism:transaction_Party_2


### Tree

* rdfs:Property
    * feudalism:transaction_Party_2
...
### URI
http://www.purl.com/net/feudalism#transaction_Party_2
...
=&gt;&nbsp;_feudalism:transaction_Party_2_&nbsp;=&gt;&nbsp;[](.md)
...
<p>:transaction_Party_2 a owl:ObjectProperty ;<br />    rdfs:label &quot;Party 2&quot;^^xsd:string ;<br />    rdfs:domain :Transaction ;<br />    rdfs:range factoid:Agent ;<br />    rdfs:subPropertyOf factoid:had_participant .</p>
