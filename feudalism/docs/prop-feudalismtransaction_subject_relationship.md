...
## Property feudalism:transaction_subject_relationship


### Tree

* rdfs:Property
    * feudalism:transaction_subject_relationship
...
### URI
http://www.purl.com/net/feudalism#transaction_subject_relationship
...
=&gt;&nbsp;_feudalism:transaction_subject_relationship_&nbsp;=&gt;&nbsp;[](.md)
...
<p>:transaction_subject_relationship a owl:ObjectProperty ;<br />    rdfs:label &quot;subject (relationship)&quot;^^xsd:string ;<br />    rdfs:domain :Transaction ;<br />    rdfs:range factoid:Agent ;<br />    rdfs:subPropertyOf factoid:had_participant .</p>
