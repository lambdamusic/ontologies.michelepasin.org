...
## Class ontology:philosurfical.owl#RELATIONAL-PROBLEM
...
* [ontology:philosurfical.owl#PROBLEM](class-ontologyphilosurficalowlproblem.md)
    ...
    * ontology:philosurfical.owl#RELATIONAL-PROBLEM


        * [ontology:philosurfical.owl#DEPENDENCE-PROBLEM](class-ontologyphilosurficalowldependence-problem.md) 

        * [ontology:philosurfical.owl#DIFFERENCE-PROBLEM](class-ontologyphilosurficalowldifference-problem.md) 

        * [ontology:philosurfical.owl#EQUALITY-PROBLEM](class-ontologyphilosurficalowlequality-problem.md) 

        * [ontology:philosurfical.owl#INDEPENDENCE-PROBLEM](class-ontologyphilosurficalowlindependence-problem.md) 
...
#### Instances of ontology:philosurfical.owl#RELATIONAL-PROBLEM can have the following properties:
