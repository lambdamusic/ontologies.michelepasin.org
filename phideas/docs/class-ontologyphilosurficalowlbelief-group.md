...
## Class ontology:philosurfical.owl#BELIEF-GROUP
...
* [ontology:philosurfical.owl#GROUP-OF-PEOPLE](class-ontologyphilosurficalowlgroup-of-people.md)
    ...
    * ontology:philosurfical.owl#BELIEF-GROUP


        * [ontology:philosurfical.owl#PHILOSOPHICAL-SCHOOL](class-ontologyphilosurficalowlphilosophical-school.md) 

        * [ontology:philosurfical.owl#POLITICAL-GROUP](class-ontologyphilosurficalowlpolitical-group.md) 

        * [ontology:philosurfical.owl#RELIGIOUS-GROUP](class-ontologyphilosurficalowlreligious-group.md) 
...
#### Instances of ontology:philosurfical.owl#BELIEF-GROUP can have the following properties:
