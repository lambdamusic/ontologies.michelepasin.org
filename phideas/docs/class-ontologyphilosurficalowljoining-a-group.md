...
## Class ontology:philosurfical.owl#JOINING-A-GROUP
...
* [ontology:philosurfical.owl#SOCIAL-ACTIVITY](class-ontologyphilosurficalowlsocial-activity.md)
    ...
    * ontology:philosurfical.owl#JOINING-A-GROUP
...
#### Instances of ontology:philosurfical.owl#JOINING-A-GROUP can have the following properties:
