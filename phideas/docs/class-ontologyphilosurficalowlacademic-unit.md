...
## Class ontology:philosurfical.owl#ACADEMIC-UNIT
...
* [ontology:philosurfical.owl#EDUCATIONAL-ORGANIZATION-UNIT](class-ontologyphilosurficalowleducational-organization-unit.md)
    ...
    * ontology:philosurfical.owl#ACADEMIC-UNIT


        * [ontology:philosurfical.owl#UNIVERSITY-FACULTY](class-ontologyphilosurficalowluniversity-faculty.md) 
...
#### URI
http://philosurfical.open.ac.uk/ontology/philosurfical.owl#ACADEMIC-UNIT
...
#### Instances of ontology:philosurfical.owl#ACADEMIC-UNIT can have the following properties:
