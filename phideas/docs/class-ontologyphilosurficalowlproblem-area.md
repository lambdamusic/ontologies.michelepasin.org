...
## Class ontology:philosurfical.owl#PROBLEM-AREA
...
* [ontology:philosurfical.owl#PHILOSOPHICAL-IDEA](class-ontologyphilosurficalowlphilosophical-idea.md)
    ...
    * ontology:philosurfical.owl#PROBLEM-AREA
...
#### Description
&quot;++PhiloSURFical : A set of problems linked by different kind of relational schemas, offer organized around a central problem.&quot;
...
#### Instances of ontology:philosurfical.owl#PROBLEM-AREA can have the following properties:
