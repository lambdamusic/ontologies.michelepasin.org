...
## Class ontology:philosurfical.owl#EXISTENCE-PROBLEM
...
* [ontology:philosurfical.owl#PROBLEM](class-ontologyphilosurficalowlproblem.md)
    ...
    * ontology:philosurfical.owl#EXISTENCE-PROBLEM


        * [ontology:philosurfical.owl#EXISTENCE-AS-ABSTRACT-PROBLEM](class-ontologyphilosurficalowlexistence-as-abstract-problem.md) 

        * [ontology:philosurfical.owl#EXISTENCE-AS-CONCRETE-PROBLEM](class-ontologyphilosurficalowlexistence-as-concrete-problem.md) 
...
#### Instances of ontology:philosurfical.owl#EXISTENCE-PROBLEM can have the following properties:
