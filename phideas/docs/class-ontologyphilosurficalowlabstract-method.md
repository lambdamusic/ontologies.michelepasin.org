...
## Class ontology:philosurfical.owl#ABSTRACT-METHOD
...
* [ontology:philosurfical.owl#METHOD](class-ontologyphilosurficalowlmethod.md)
    ...
    * ontology:philosurfical.owl#ABSTRACT-METHOD


        * [ontology:philosurfical.owl#ARGUMENTATIVE-METHOD](class-ontologyphilosurficalowlargumentative-method.md) 

        * [ontology:philosurfical.owl#LOGICAL-MATHEMATICAL-METHOD](class-ontologyphilosurficalowllogical-mathematical-method.md) 

        * [ontology:philosurfical.owl#RULE-OF-INFERENCE](class-ontologyphilosurficalowlrule-of-inference.md) 
...
#### URI
http://philosurfical.open.ac.uk/ontology/philosurfical.owl#ABSTRACT-METHOD

#### Description
&quot;++PhiloSURFical : A procedure of reasoning or an abstract methodology. For example, the dialectic method in Plato, the epoche&#39; in Husserl, Baco&#39;s scientific method or the absolute doubt of Descates&quot;
...
#### Instances of ontology:philosurfical.owl#ABSTRACT-METHOD can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="ontology:philosurfical.owl#ABSTRACT-METHOD" href="class-ontologyphilosurficalowlabstract-method.md" class="rdfclass">ontology:philosurfical.owl#ABSTRACT-METHOD</a></span>
            </th>
        </tr>       
        ...
        <tr style="background: lightcyan;text-align: left;">
            <th colspan="3" height="10" class="treeinfo"><span style="font-size: 80%;">
            From <a title="ontology:philosurfical.owl#METHOD" href="class-ontologyphilosurficalowlmethod.md" class="rdfclass">ontology:philosurfical.owl#METHOD</a></span>
            </th>
        </tr>       
            ...
            <tr>
                <td class="firsttd">
                    <a class="propcolor" title="ontology:philosurfical.owl#IS-DEFINED-BY-VIEW" href="prop-ontologyphilosurficalowlis-defined-by-view.md">ontology:philosurfical.owl#IS-DEFINED-BY-VIEW</a>         
                </td>
                <td class="thirdtd">
                    <span></span>
                </td>
            ...
            <tr>
                <td class="firsttd">
                    <a class="propcolor" title="ontology:philosurfical.owl#IS-USED-BY-VIEW" href="prop-ontologyphilosurficalowlis-used-by-view.md">ontology:philosurfical.owl#IS-USED-BY-VIEW</a>         
                </td>
                <td class="thirdtd">
                    <span></span>
                </td>
            ...
            <tr>
                <td class="firsttd">
                    <a class="propcolor" title="ontology:philosurfical.owl#USED-BY-ARGUMENT" href="prop-ontologyphilosurficalowlused-by-argument.md">ontology:philosurfical.owl#USED-BY-ARGUMENT</a>         
                </td>
                <td class="thirdtd">
                    <span></span>
                </td>
