...
### URI
http://www.purl.com/net/artofmaking.owl#Text
...
<p>:Text a owl:Class ;<br />    rdfs:subClassOf :Document .</p>
...
### Instances of artofmaking.owl:Text can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="artofmaking.owl:Text" href="class-artofmakingowltext.md" class="rdfclass">artofmaking.owl:Text</a></span>
            </th>
        </tr>       
