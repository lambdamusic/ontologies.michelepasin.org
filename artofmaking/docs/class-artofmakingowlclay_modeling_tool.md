...
## Class artofmaking.owl:Clay_Modeling_Tool
...
* [artofmaking.owl:Tool](class-artofmakingowltool.md)
    ...
    * artofmaking.owl:Clay_Modeling_Tool


        * [artofmaking.owl:Wire_End_Tools](class-artofmakingowlwire_end_tools.md) 
...
### URI
http://www.purl.com/net/artofmaking.owl#Clay_Modeling_Tool
...
<p>:Clay_Modeling_Tool a owl:Class ;<br />    rdfs:subClassOf :Tool .</p>
...
### Instances of artofmaking.owl:Clay_Modeling_Tool can have the following properties:
...
<table border="1" cellspacing="3" cellpadding="5" class="classproperties table-hover ">
    ...
    <tr>
        ...
        <tr style="background: lightcyan;text-align: left;">
            ...
            From <a title="artofmaking.owl:Clay_Modeling_Tool" href="class-artofmakingowlclay_modeling_tool.md" class="rdfclass">artofmaking.owl:Clay_Modeling_Tool</a></span>
            </th>
        </tr>       
